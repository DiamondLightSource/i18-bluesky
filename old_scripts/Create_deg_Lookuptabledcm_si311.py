...
#
converter = finder.find("auto_mDeg_idGap_mm_converter_Si311")

converter.enableAutoConversion()

pos sc_comboDCM_d_Si311 angleStart/1000.0
...
lookup = finder.find("lookup_name_provider_Si311")
...
new_harmonic_file='/dls/science/groups/i18/lookuptables/Fe_311_Feb23_c.txt'

...
from gdaserver import counterTimer01
#
...
def scangap(start_gap,stop_gap,step_gap):
	...
	counterTimer01.setCollectionTime(1)
	for i in range(npoints):
		pos sc_idgap currentgap
		xdata[i] = currentgap
		counterTimer01.collectData()
		counterTimer01.waitWhileBusy()
		ydata[i] = counterTimer01.getPosition()[1]
...
new_harmonic_file='/dls/science/groups/i18/lookuptables/Zn_2021_NewMono.txt'
